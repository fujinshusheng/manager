                    ...
                    <div class="layui-input-block">
                      <?php 
                            ...
                            foreach ($info as $k=>$r) {
                                ...
                                $str_info .= "<input type='text' class='info' name=\"info[]\" _id='$_id' value='$r'>";
                                $progress = "<div class='layui-progress' lay-showPercent=\"yes\"><div class='layui-progress-bar' lay-percent='100%'></div></div>";
                                $btn = '<button type="button" class="layui-btn layui-btn-sm layui-btn-danger big_del" _id="'.$_id.'" _save_name="'.($rs->save_name).'">删除</button>';
                                $str_info_fileinfo .= "<tr><td>".($rs->source_name)."</td><td>".(formatFileSize($rs->size))."</td><td id='$c_'>100%</td><td id='$u_'>$progress</td><td id='$do_'>$btn</td></tr>";
                            }
                         ?>
