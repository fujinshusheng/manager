    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">类别管理　　<a href="javascript:;" _pid ="0" class="layui-btn layui-btn-normal layui-btn-xs add">添加一级类别</a></div>
