    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">栏目管理　　<a href="javascript:;" _pid ="0" class="layui-btn layui-btn-normal layui-btn-xs add">添加一级栏目</a> <a href="javascript:;" class="layui-btn layui-btn-danger layui-btn-xs">最多支持三级</a></div>
         ...
         <form class="layui-form">
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input type="text" min="0" id="urls" name="urls" maxlength="200"  autocomplete="off" class="layui-input">
              </div>
            </div>
  ...
  layui.config({
    ...
    ,ytajax:'yteng/ytajax'//定义的 ajax 模块
       ...
       $(document).on("click",".submit",function(){
            ...
            if(!sortname){
                layer.msg("栏目名称不能为空",{icon:2,time:1000},function(){
                    $("#sortname").focus();
                });
            }
       ...
       $(document).on("blur",".orders",function(){
           ...
           ytajax({data:data,url:'{:url("yteng/column/saveorders")}'});
       })
       //删除类别 begin
