                ...
                <div class="layui-field-box layui-form">
                   <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                      <input type="text" name="title" id="title" value="{$row.title}" lay-verify="required" lay-verType="tips" autocomplete="off" class="layui-input" maxlength="20" style="width: 250px;">
                    </div>
                  </div>
                  <div class="layui-form-item">
                    <label class="layui-form-label">链接地址</label>
                    <div class="layui-input-block">
                      <input type="text" name="linkurl" value="{$row.linkurl}" id="linkurl" maxlength="100"  autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                   ...
                   <div class="layui-form-item">
                      ...
                      <div class="layui-input-block">
                        <input type="radio" name="isshow" value="1" title="是" <?php if($row["isshow"]==1){echo "checked";}?>>
                        <input type="radio" name="isshow" value="2" title="否" <?php if($row["isshow"]==2){echo "checked";}?>>
                      </div>
                    </div>
                    <div class="layui-form-item">
                      <div class="layui-input-block">
