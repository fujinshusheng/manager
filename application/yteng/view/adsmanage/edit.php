        ...
        <div class="layui-card">
          <div class="layui-card-body" pad15>
            <fieldset class="layui-elem-field">
                <legend>广告添加</legend>
                <div class="layui-field-box layui-form" lay-filter="layui-form">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      ...
                      <div class="layui-upload-list">
                        <img class="layui-upload-img" id="demopic" style="max-width: 150px;" src="<?php echo config("app.rootfpath")."/".$row["pic"];?>">
                        <p id="FailText"></p>
                      </div>
